            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td width="80px">姓名<input type="hidden" name="id" value="${u.id }"></td>
							<td><input type="text" name="username" class="InputStyle" value="${u.username }"/> *</td>
						</tr>
						<tr>
							<td>联系电话</td>
							<td><input type="text" name="phone" class="InputStyle" value="${u.phone }"/> *</td>
						</tr>
						<tr>
							<td>性别</td>
							<td><input type="text" name="sex" class="InputStyle" value="${u.sex }"/> *</td>
						</tr>
						<tr>
							<td>地址</td>
						...
						<tr>
							<td>密码</td>
							<td><input type="text" name="password" class="InputStyle" value="${u.password }"/> *</td>
						</tr>
