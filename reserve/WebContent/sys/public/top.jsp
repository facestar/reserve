...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">火锅店后台管理</b> <!-- <img border="0" src="style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		...
		<div id="Head_1_FunctionButton">
			...
			<a target="_parent"  href="javascript:window.close()" <%-- href="${pageContext.request.contextPath }/user/exit.do" --%>>
