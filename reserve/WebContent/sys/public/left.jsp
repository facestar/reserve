	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/foodtype/findalltype.do">火锅种类管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/food/findallfood.do">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/orders/orderList.do">餐厅订单</a>
				</li>
				<li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/user/findalluser.do">用户管理</a>
				</li>
				<%-- <li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/orders/dhuiz.do">当日汇总</a>
				</li> --%>
				<%-- <li class="level2 level2Style">
					<a target="right" href="${pageContext.request.contextPath }/sys/findalluser.do">当月汇总</a>
				</li> --%>
            </ul>
        </li>
    </ul>
