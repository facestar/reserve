			...
			<div id="foot">
				...
				<div id="btn" >
					...
					当前${pagebean.nowpage}/${pagebean.allpage}页 &nbsp;	
					 <a href="${pageContext.request.contextPath }/food/fenye.do?nowpage=1&&allpage=0&&leixing=素菜">首页</a>
					 <a href="${pageContext.request.contextPath }/food/fenye.do?nowpage=${pagebean.nowpage-1}&&allpage=0&&leixing=素菜">上一页</a>
					 <a href="${pageContext.request.contextPath }/food/fenye.do?nowpage=${pagebean.nowpage+1}&&allpage=0&&leixing=素菜">下一页</a>
					 <a href="${pageContext.request.contextPath }/food/fenye.do?nowpage=1&&allpage=1&&leixing=素菜">尾页</a>
